...
.bgimg-1 {
  background-image: url('/public/images/lasAcacias1.jpg');
  min-height: 100%;
}
...
<div class="w3-top">
  <div class="w3-bar" id="myNavbar">
    ...
    <a href="/inicio" class="w3-bar-item w3-button">Iniciar Sesión</a>
  </div>
...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity"><a href="/turistas" class="w3-bar-item w3-button">Módulo para turistas</a></span>
  </div>
</div>

<!-- Container (About Section) -->
<div class="w3-content w3-container w3-padding-64" id="about">
  <h3 class="w3-center">Las Acacias Coffee Farm</h3>
